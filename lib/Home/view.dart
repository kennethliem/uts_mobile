...
import 'package:uts_mobile/Joblist/view.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              padding: EdgeInsets.fromLTRB(SafePadding, 2*SafePadding, SafePadding, 0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                      'Hii ${widget.displayName},',
